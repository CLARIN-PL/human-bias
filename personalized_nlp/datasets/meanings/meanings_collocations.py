...
class MeaningsCollocationsDataModule(BaseDataModule):
    def __init__(
            self,
            data_dir: str = STORAGE_DIR / 'emotions_data/collocations/meanings/',
            batch_size: int = 3000,
        ...
        super(MeaningsCollocationsDataModule, self).__init__()

        self.folds_num = 10
        self.data_dir = data_dir
        self.data_path = self.data_dir / 'cawi1_collocations.csv'
        self.data_url = None
        ...
        self.embeddings_path = STORAGE_DIR / \
            f'emotions_data/collocations/embeddings/text_id_to_emb_{embeddings_type}_{language}.p'
    ...
    def prepare_data(self) -> None:
        self.data = pd.read_csv(
            self.data_dir / 'cawi1_collocations.csv')
