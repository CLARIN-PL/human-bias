...
class ToxicityDataModule(WikiDataModule):
    def __init__(
            self,
            data_dir: str = STORAGE_DIR / 'wiki_data/toxicity/texts',
            batch_size: int = 3000,
        ...
        self.embeddings_path = STORAGE_DIR / f'wiki_data/toxicity/embeddings/rev_id_to_emb_{embeddings_type}_toxic.p'